            ...
            >
                ...
                >
                  ...
                  <div class="flex flex-col gap-1 mt-2">
                    ...
                    <p class="italic text-gray-300">{{ item.description }}</p>
                    <button
                @click="openRepository(item.repository)"
                class="font-bold text-gray-500 self-end bg-yellow-500 hover:bg-yellow-600 py-2 px-4 rounded"
              >
                DEMO
              </button>
                  </div>
